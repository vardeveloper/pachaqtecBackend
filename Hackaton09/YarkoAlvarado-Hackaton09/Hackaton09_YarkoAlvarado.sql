-- Database: Hackaton09-YarkoAlvarado

-- DROP DATABASE IF EXISTS "Hackaton09-YarkoAlvarado";
...
-- Para mi ejemplo pusé mayor de 50 ya que el rango de precios es de 0 a 100
select Nombre,precio, Stock 
from Productos
where Precio > 50;

--  6. Muestra los nombres de los empleados cuyo salario sea superior a 50000.
-- Para mi ejemplo pusé mayor de 2500 ya que el rango de salarios es de 1206.00 a 3175.00
...
--  9. Muestra el nombre del producto y la cantidad vendida de todos los productos que tengan
-- una cantidad vendida superior a 100.
...
--  11. Calcula el promedio de edad de todos los empleados.
...
-- en mi ejemplo use 100
select nombre, stock from productos
where stock < 100

--  15. Selecciona el nombre del producto y la cantidad vendida de todos los productos
--      que tengan una cantidad vendida entre 50 y 100.
...
--  20. Selecciona el nombre del producto y el nombre del cliente de todos los productos vendidos
--      en el último mes.
